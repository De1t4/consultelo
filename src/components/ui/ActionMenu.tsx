      ...
      <div className={`relative inline-block ${className}`} ref={containerRef}>
        ...
        {show && (
          <div
            ...
            className={`absolute z-50 mt-2 min-w-40 bg-card border border-border rounded-xl shadow-xl overflow-hidden py-1.5 animate-in fade-in zoom-in duration-200 
